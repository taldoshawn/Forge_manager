...
class SmaliStudioActivity : ForgeActivity() {
    ...
    companion object{const val EXTRA_CLASS_DESCRIPTOR="class_descriptor";private const val API_LEVEL=30;private const val MAX_DEX_BYTES=256L*1024*1024;private const val MAX_LISTED_FILES=50_000}
}
